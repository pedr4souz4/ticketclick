...
<html>
  <head>
    <title>TicketClick - Perfil do Organizador</title>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="criar_evento.php">Criar Evento</a>
              <a class="dropdown-item" href="meus_eventos.php">Meus Eventos</a>
        ...
        ?>
          <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form role="form" action="" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="cep" id="cep" maxlength="10" placeholder="00.000-000" onblur="pesquisacep(this.value);" value="<?php echo $cepUser; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Avatar do organizador</label>
                  ...
                  <div class="card-footer">
                    <button type="submit" name="upPerfil" class="btn btn-primary">Alterar dados do organizador</button>
                  </div>
                </form>
                <?php
                  ...
                  $update = "UPDATE cadastro_organizador SET foto=:foto,nome=:nome,senha=:senha,celular=:celular,cpf=:cpf,data_nasc=:data_nasc,cep=:cep,endereco=:endereco,bairro=:bairro,numero=:numero,complemento=:complemento,cidade=:cidade,estado=:estado WHERE email=:email";
                  try{
                    ...
                    if($contar>0){
                      ...
                      echo "<script>location.href=\"perfil_organizador.php\";alert('Perfil atualizado com sucesso!');</script>";
                    

                    }else{
                      echo "<script>location.href=\"perfil_organizador.php\";alert('Erro!!! Perfil não foi atualizado!');</script>";
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Dados do Organizador</h3>
                </div>
                <!-- /.card-header -->
    ...
    <script type="text/javascript" src="perfil_organizador.js"></script>
  </body>
</html>
