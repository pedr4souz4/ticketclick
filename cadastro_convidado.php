		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="cadastro_convidado.php" method="POST" id="login-form" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input">
                    <span class="focus-input100" data-placeholder="Sexo*"></span><br><br>
                    <select class="form-check" name="sexo" id="sexo" required>
                        <option value="-1" disabled="true">Sexo</option>
                    ...
                    <div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="CPF" id="CPF" required maxlength="11">
