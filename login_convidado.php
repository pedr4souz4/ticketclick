...
<html lang="en">
	<head>
		<title>TicketClick - Login Convidado</title>
		<meta charset="UTF-8">
		...
		<a class="btn-menu btn ml-md-2" href="#organizador" onclick="goBack()">Voltar</a>
			<div class="container-login100">
				<div class="wrap-login100">
					<form action="logar.php" method="POST" id="login-form" class="login100-form validate-form">
						<span class="login100-form-title p-b-26">
							Login
						</span>
						<center><a class="btn-menu btn ml-md-2" href="login_organizador.php">Organizador</a></center>
						...
						<div class="text-center p-t-100">
							...
							<a class="txt2" href="cadastro_convidado.php">
								Cadastre-se
							</a>
						</div>
					</form>
