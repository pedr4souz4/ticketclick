...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/ticketclick/cadastro_convidado.php">
     ...
     <link rel="stylesheet" href="/ticketclick/CSSeventos/animesummit.css">

    <Title>Anime Summit</Title>
  ...
  <body>
    ...
    <div class="texto-animado">
      ...
      <p class="animated flipInX delay-15">Animesummit</p>         
    </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="card" style="width: 18rem;">
              <img src="/ticketclick/img/anime.png" class="card-img-top" alt="..." width=850 height=250>
              <div class="card-body">
                <h5 class="card-title">Animesummit</h5>
