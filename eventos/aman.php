...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/ticketclick/cadastro_convidado.php">
     ...
     <link rel="stylesheet" href="/ticketclick/CSSeventos/aman.css">

    <Title>Teatro da Aman</Title>
  ...
  <body>
    ...
    <div class="texto-animado">
      ...
      <p class="animated flipInX delay-15">Teatro da Aman</p>         
    </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="card" style="width: 18rem;">
              <img src="img/lollapalooza.jpg" class="card-img-top" alt="..." width=850 height=250>
              <div class="card-body">
                <h5 class="card-title">Teatro da Aman</h5>
                <p class="card-text"><i class="fas fa-calendar me-1"></i>12/08/2022</p>
                <p class="card-text"><i class="fas fa-map me-1"></i>07/06/2023</p>
                <a href="eventos/lollapalooza.php" class="btn btn-primary">Comprar Ingresso</a>
              </div>
            </div>
          </div>
      <br><br/>
